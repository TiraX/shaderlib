...
function TiEngine(canvas) {
	...
	// load probes
	this._renderer.LoadBrdfLut( "res/tex/env_default_brdf_lut.dds" );
	this._renderer.LoadDiffProbe( "res/tex/env_default_diff.thdr.gz" );
	this._renderer.LoadSpecProbe( "res/tex/env_default_spec.thdr.gz" );
